        ...
        <div class="layui-row layui-col-space20">
            <div class="layui-col-sm12 layui-col-md12">
                <div class="layui-card">
                    <div class="layui-card-header">人员列表<button type="button"
                            class="layui-btn layui-btn-sm layui-btn-blue cardButton" id="add"><i
                                class="layui-icon">&#xe654;</i>增加人员</button></div>
            ...
            <form class="layui-form mar-t-20" id="add-form" action="" style="display:none">
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 100px"><span class="mustFill"></span>姓名：</label>
                    <div class="layui-input-block">
                        <input type="text" name="userName"  value="" style="width: 300px"
                            lay-verify="required|dayFlow" maxlength="50" placeholder="请输入姓名" lay-reqtext="请输入姓名" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="password" name="password" style="width: 300px" lay-verify="required|pass"
                            placeholder="请输入密码" lay-reqtext="请输入密码" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <!-- <div class="layui-form-item">
        ...
        table.render({
            ...
            cols: [[ //标题栏
                ...
                { field: 'caozuo', title: '操作', width: 240, templet: function (d) {
                	if(d.status === '2'){
                        return '<a class="layui-btn layui-btn-blue layui-btn-xs" lay-event="setrole">设置角色</a><a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="edit">编辑</a>';
                	}
