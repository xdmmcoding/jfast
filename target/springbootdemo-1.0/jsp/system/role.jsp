        ...
        <div class="layui-row layui-col-space20">
            <div class="layui-col-sm12 layui-col-md12">
                <div class="layui-card">
                    <div class="layui-card-header">角色列表<button type="button" id="add"
                            class="layui-btn layui-btn-sm layui-btn-blue cardButton"><i
                                class="layui-icon">&#xe654;</i>增加角色</button></div>
    ...
    layui.use(['jquery', 'table', 'form', 'layer','common','eleTree'], function (obj) {
		...
		form.on('submit(saveauth)',function(data){
			...
			if(checkd != null && checkd.length>0){
    			...
    			layer.msg('请选择要配置的权限菜单', { icon: 0, anim: 6, time: 1000,  shade: [0.8, '#393D49'] });
    			return false;
      		}
        });
		//获取角色下人员
